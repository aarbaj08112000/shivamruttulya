...
class Shop extends MY_Controller {
    ...
    public function shop_list()
    {
        ...
        $data["next_shop_code"] = $this->Shop_model->get_next_shop_code();
        $this->smarty->loadView('shop_list.tpl', $data,'Yes','Yes');
    }
    public function get_shop_list()
    {
        ...
        $data = $this->Shop_model->get_shop_view_data(
            $condition_arr,
            $post_data["search"]
        );
        ...
        $response = array();
        $response["data"] = $data;
        $total_record = $this->Shop_model->get_shop_view_count([], $post_data["search"]);
    ...
    public function add_shop_action() {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST') {
            ...
            $insert_id = $this->Shop_model->insert_shop($data);
    ...
    public function get_shop_details() {
        ...
        $shop = $this->Shop_model->get_shop_by_id($shop_id);
    ...
    public function update_shop_action() {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST') {
            ...
            $updated = $this->Shop_model->update_shop($shop_id, $data);
    ...
    public function delete_shop_action() {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST') {
            ...
            $deleted = $this->Shop_model->delete_shop($shop_id);
