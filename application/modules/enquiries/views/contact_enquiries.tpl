      ...
      <nav aria-label="breadcrumb">
         <div class="sub-header-left pull-left breadcrumb m-0">
            <h1 class="mb-0">
               ...
               <em style="color: var(--bs-theme-color-dark) !important;">Contact Us</em></a>
            </h1>
         </div>
      </nav>
               ...
               <div class="col-lg-12">
                  <div class="card w-100 table-card">
                     <div class="table-responsive text-nowrap">
                         <table id="contact_enquiries_table" class="table table-striped table-hover w-100" style="border-collapse: collapse;">
                            <thead>
                                <tr>
                     ...
                     <!-- View Contact Enquiry Offcanvas -->
                     <div class="offcanvas offcanvas-end" tabindex="-1" id="viewContactOffcanvas" aria-labelledby="viewContactOffcanvasLabel" style="width: 500px;">
                        <div class="offcanvas-header pb-2" style="border-bottom: 1px solid #eee;">
                           <div>
                              <h5 class="offcanvas-title mb-1" id="viewContactOffcanvasLabel" style="color: var(--bs-theme-color-dark); font-weight: bold;">View Enquiry</h5>
                              <p class="text-muted mb-0" style="font-size: 13px;">Contact Us details</p>
                           </div>
                        ...
                        <div class="offcanvas-body">
                           ...
                           <div class="row mb-3">
                              <div class="col-12 mb-3">
                                 ...
                                 <div id="view_contact_name" class="fw-bold" style="font-size: 14px;"></div>
                              </div>
                              <div class="col-6 mb-3">
                                 <label class="form-label text-muted" style="font-size: 12px; margin-bottom: 2px;">Mobile</label>
                                 <div id="view_contact_phone" class="fw-bold" style="font-size: 14px;"></div>
                              </div>
                              <div class="col-6 mb-3">
                                 <label class="form-label text-muted" style="font-size: 12px; margin-bottom: 2px;">Email</label>
                                 <div id="view_contact_email" class="fw-bold" style="font-size: 14px;"></div>
                              </div>
                           </div>
                           
                           <h6 class="text-warning mb-3 mt-4" style="font-size: 13px; font-weight: bold;">Message Details</h6>
                           <div class="row mb-3">
                              <div class="col-12 mb-3">
                                 <label class="form-label text-muted" style="font-size: 12px; margin-bottom: 2px;">Submitted On</label>
                                 <div id="view_contact_date" class="fw-bold" style="font-size: 14px;"></div>
                              </div>
                              <div class="col-12 mb-3">
                                 <label class="form-label text-muted" style="font-size: 12px; margin-bottom: 2px;">Message</label>
                                 <div id="view_contact_message" class="fw-bold p-3 bg-light rounded" style="font-size: 14px; white-space: pre-wrap;"></div>
                              </div>
                           </div>
                        </div>
...
<script src="<%$base_url%>public/js/enquiries/contact_enquiries.js?v=<%time()%>"></script>
