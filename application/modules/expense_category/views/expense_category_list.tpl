                  ...
                  <div class="card w-100 table-card">
                     ...
                     <div class="offcanvas offcanvas-end" tabindex="-1" id="addCategoryOffcanvas" aria-labelledby="addCategoryOffcanvasLabel" style="width: 500px;">
                        ...
                        <div class="offcanvas-body">
                           <form id="addCategoryForm" action="<%base_url('expense_category/expense_category/add_expense_category_action')%>" method="POST">
                     ...
                     <div class="offcanvas offcanvas-end" tabindex="-1" id="editCategoryOffcanvas" aria-labelledby="editCategoryOffcanvasLabel" style="width: 500px;">
                        ...
                        <div class="offcanvas-body">
                           <form id="editCategoryForm" action="<%base_url('expense_category/expense_category/update_expense_category_action')%>" method="POST">
...
<style type="text/css">
 ...
 <script>
  ...
  <script src="<%$base_url%>public/js/expense_category/expense_category_list.js"></script>
