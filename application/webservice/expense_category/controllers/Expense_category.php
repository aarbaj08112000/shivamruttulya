...
class Expense_category extends My_Api_Controller
{
    ...
    public function list_get()
    {
        ...
        $categories = $this->Expense_category_model->get_all($limit, $offset, $search);
        
        $total_records = $this->Expense_category_model->get_total_count($search);
    ...
    public function add_post()
    {
        ...
        $insert_id = $this->Expense_category_model->insert($insert_data);
    ...
    public function update_post($id = null)
    {
        ...
        $affected = $this->Expense_category_model->update($id, $update_data);
    ...
    public function delete_post($id = null)
    {
        ...
        $affected = $this->Expense_category_model->delete($id, $this->current_user->id);
