...
class Group_model extends CI_Model {
    ...
    {
        // Table config_setting does not exist in shiv_amruttulya database,
        // returning essential configs manually.
        return [
            ['name' => 'company_name', 'value' => 'Shiv Amruttulya'],
            ['name' => 'company_fav_icon', 'value' => 'public/uploads/fav_shiv_amruttulya.png'],
            ['name' => 'company_logo', 'value' => 'public/uploads/shiv_amruttulya.jpeg'],
        ];
    }
}
