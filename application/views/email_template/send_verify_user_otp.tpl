                                       ...
                                       <tbody>
                                          <tr>
                                             <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 30px;font-family:'Raleway',sans-serif;" align="left">
                                                <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 28px; font-weight: 400;"><strong>Verify otp</strong></h1>
                                             </td>
                                          </tr>
                                       </tbody>
                                    </table>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 60px 10px;font-family:'Raleway',sans-serif;" align="left">
                                                <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 16px; font-weight: 400;margin-bottom: 6px;">Dear <%$user%>,</h1>
                                                <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 16px; font-weight: 400;margin-bottom: 6px;">We detected a login attempt to your account from a new or different device.</h1>
                                                <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 16px; font-weight: 400;margin-bottom: 6px;">For your security, please use the following One-Time Password (OTP) to verify your login:</h1>
                                                <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 16px; font-weight: 400;margin-bottom: 6px; "><span style="margin: 25px 0 26px;line-height: 140%;text-align: left;word-wrap: break-word;font-size: 20px;font-weight: 600;display: flex;">OTP :  &nbsp;<p style="margin-left: 7px !important;color: green;margin: 0px;"><%$otp%></p> </span></h1>
                                                <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 16px; font-weight: 400;margin-bottom: 6px;">This OTP is valid for the next <%$valid_upto%> minutes. Please do not share this code with anyone.</h1>
                                                <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 16px; font-weight: 400;margin-bottom: 6px;">If this login attempt was not made by you, please ignore this email (<%$company_email%>) or contact (<%$company_contact%>) our support team immediately.</h1>
                                          ...
                                          <tr>
                                             <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 100px 30px;font-family:'Raleway',sans-serif;" align="left">
                                                <div class="v-font-size" style="font-size: 14px; line-height: 170%; text-align: center; word-wrap: break-word;">
                                                   <p style="font-size: 14px; line-height: 170%;">Copyright &copy; 2022 | <%$company_name%> | All rights reserved</p>
