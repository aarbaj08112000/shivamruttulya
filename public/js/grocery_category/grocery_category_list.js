...
var table = '';
var file_name = "grocery_category_list";
var pdf_title = "Grocery Category List";
...
const page = {
    ...
    dataTable: function(){
        table = new DataTable("#category_management_table", {
            ...
            ajax: {
                url: "grocery_category/grocery_category/get_grocery_category_list",
                type: "POST",
            }
        });
    ...
    editCategory: function() {
        $(document).on('click', '.edit-category', function() {
            ...
            $.ajax({
                url: base_url + 'grocery_category/grocery_category/get_grocery_category_details',
                type: 'POST',
                data: { id: category_id },
                dataType: 'json',
                success: function(response) {
    ...
    deleteCategory: function() {
        $(document).on('click', '.delete-category', function() {
            ...
            swal({
                ...
                if (result.value) {
                    $.ajax({
                        url: base_url + 'grocery_category/grocery_category/delete_grocery_category_action',
                        type: 'POST',
                        data: { id: category_id },
                        dataType: 'json',
                        success: function(response) {
