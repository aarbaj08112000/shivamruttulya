...
var table = '';
var file_name = "expense_category_list";
var pdf_title = "Expense Category List";
...
const page = {
    ...
    dataTable: function(){
        table = new DataTable("#category_management_table", {
            dom: "Bfrtilp",
            buttons: [
              {     
                    extend: 'csv',
            ...
            ajax: {
                url: "expense_category/expense_category/get_expense_category_list",
                type: "POST",
            }
        });
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success == 1) {
                            ...
                            $('#addCategoryOffcanvas').offcanvas('hide');
                            form.reset();
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success == 1) {
                            toaster("success", response.msg);
                            $('#editCategoryOffcanvas').offcanvas('hide');
                            form.reset();
                            table.ajax.reload(null, false);
                        } else {
                            toaster("error", response.msg);
    ...
    editCategory: function() {
        $(document).on('click', '.edit-category', function() {
            ...
            $.ajax({
                url: base_url + 'expense_category/expense_category/get_expense_category_details',
                type: 'POST',
                data: { id: category_id },
                dataType: 'json',
                success: function(response) {
                    if (response.success == 1) {
                        ...
                        var bsOffcanvas = new bootstrap.Offcanvas(document.getElementById('editCategoryOffcanvas'));
                        bsOffcanvas.show();
                    } else {
                        toaster('error', response.msg);
                    }
                ...
                error: function() {
                    toaster('error', 'An error occurred while fetching category details.');
                }
            });
        });
    },
    deleteCategory: function() {
        $(document).on('click', '.delete-category', function() {
            ...
            swal({
                ...
                if (result.value) {
                    $.ajax({
                        url: base_url + 'expense_category/expense_category/delete_expense_category_action',
                        type: 'POST',
                        data: { id: category_id },
                        dataType: 'json',
                        success: function(response) {
